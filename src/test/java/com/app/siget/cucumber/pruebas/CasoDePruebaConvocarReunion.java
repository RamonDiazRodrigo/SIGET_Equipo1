...
public class CasoDePruebaConvocarReunion {
	...
	public void y_involucrados(String nombre, String dia, String horaI, String minutosI, String horaF,
			String minutosF, String usuarios, String semana) throws NumberFormatException {
		nombre="asistente";
		dia="LUNES";
		horaI="15";
		minutosI="00";
		...
		Manager.get().convocarReunion(nombre, dia, horaI, minutosI, horaF, minutosF, usuarios, "true", semana);
	}
